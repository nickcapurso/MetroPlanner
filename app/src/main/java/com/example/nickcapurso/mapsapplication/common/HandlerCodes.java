package com.example.nickcapurso.mapsapplication.common;
...
public final class HandlerCodes {
    ...
    public static final byte ADDRESS_PICKER_CANCELLED = 0x13;
    public static final byte ADDRESS_PICKER_ERR = 0x14;
    public static final byte FETCH_DELAY_DONE = 0x15;
    public static final byte UPDATE_PROGRESS = 0x16;
