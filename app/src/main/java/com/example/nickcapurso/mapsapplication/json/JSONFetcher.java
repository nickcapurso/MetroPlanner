...
public class JSONFetcher extends AsyncTask<String, Void, String>{
    ...
    private static final String GOOD_RESULT = "okay";

    //TODO use interface instead of Handler next time (its all on the UI thread anyway)
